...
");
    ...
    public void RemoveClient(string clientId) => _trafficStats.TryRemove(clientId, out _);
    public ClientTrafficStats GetClientStats(string clientId) => _trafficStats.GetOrAdd(clientId, _ => new ClientTrafficStats());
...
public class ClientTrafficStats {
    ...
    public List<long> SendSpeedHistory { get; } = new();
    public List<long> ReceiveSpeedHistory { get; } = new();
...
public class TrafficReport {
    ...
    public long CurrentSendSpeed { get; set; }
    public long CurrentReceiveSpeed { get; set; }
    public Dictionary<string, ClientTrafficStats> Clients { get; set; } = new();
}